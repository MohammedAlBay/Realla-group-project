        ...
        <div className="relative" style={{ top: '-40px' }}>
          ...
          <div className="flex justify-between items-center">
            {timelineData.map((item, index) => (
             ...
             <div className="absolute mt-16 text-center bg-white p-4 rounded shadow-lg z-10 transition duration-200 transform hover:scale-105 border border-solid" style={{ minWidth: '200px', minHeight: '80px', padding: '10px', borderColor: '#fdb514', boxShadow: '2px 2px 4px 0px rgba(253, 181, 20, 0.5)'}}>
