...
const MailboxTenant = () => { 
    ...
    return (
        <div className="relative h-screen flex justify-center items-center">
            <div className="mr-8 w-4/5 h-2/3 flex-shrink-0 rounded-xl bg-white shadow-lg relative" style={{ width: '80%', boxShadow: '0 12px 16px rgba(0.1, 0.1, 0.1, 0.1), 0 3px 6px rgba(0, 0, 0, 0.08)' }}>
                <div style={{ padding: '20px' }}>
                    <h3 style={{ marginTop: '10px', marginLeft: '10px' }}>Message</h3>
                </div>
                <div class="message-role">Gardner</div>
