...
const CircularSliderCarousel = () => {
    ...
    return (
        <div className="circular-slider-carousel">
            ...
            <h1 className="text-dashboard-landing">Welcome <span>Luc Declercq{/*{userAddress}*/} </span>!</h1>
            {/* Render user address with dynamic value */}
            <h4 className="address-dashboard-landing"><i className='bx bxs-map' style={{ color: '#FDB414', fontSize: '30px' }}></i> <span>Gent {userAddress} </span>
            </h4>
